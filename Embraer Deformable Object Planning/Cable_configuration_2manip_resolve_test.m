...
[SystemNode ParentNode flag] = GraspCableParallel(SystemNode, 2, 2, 80)
PlotStateLargeGoal(SystemNode)
...
% [SystemNode ParentNode flag] = ReleaseManipulatorParallel(SystemNode, 2)
% PlotStateLargeGoal(SystemNode)
% 
% [SystemNode ParentNode flag] = ClampCable(SystemNode, 1, 2)
% PlotStateLargeGoal(SystemNode)
...
[SystemNode ParentNode flag] = GraspCable(SystemNode, 2 , 2, 21);
PlotStateLargeGoal(SystemNode)
...
% 
% 
% [SystemNode ParentNode flag] = GraspCable(SystemNode, 2, 1, 60);
% UsedManipulator = 2;
% 
% [SystemNode] = ResolveInterlinkControlProblem(SystemNode, UsedManipulator)
% PlotStateLargeGoal(SystemNode)
% 
% [SystemNode ParentNode flag] = GraspCable(SystemNode, 1, 1, 21)
% PlotStateLargeGoal(SystemNode)
...
% PlotStateLargeGoal(SystemNode)
% 
% [SystemNode ParentNode flag] = GraspCable(SystemNode , 2, 2, 140);
% PlotStateLargeGoal(SystemNode)
% 
% [SystemNode ParentNode flag] = ClampCable(SystemNode, 1 , 2)
% PlotStateLargeGoal(SystemNode)
...
% 
% [SystemNode ParentNode flag] = GraspCable(SystemNode, 1 , 2 , 131);
% [SystemNode ParentNode flag] = GraspCable(SystemNode, 2, 3, 140);
% PlotStateLargeGoal(SystemNode)
% 
% [SystemNode ParentNode flag] = ClampCable(SystemNode , 1 , 2);
% PlotStateLargeGoal(SystemNode)
