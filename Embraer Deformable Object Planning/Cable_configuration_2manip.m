...
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
    F(LoopCount) = getframe;
end
...
SystemNode = GraspCable(SystemNode, 2 , 2, 20);
PlotStateLargeGoal(SystemNode)
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
...
SystemNode = ReleaseManipulator(SystemNode, 2);
PlotStateLargeGoal(SystemNode)
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
...
SystemNode = GraspCable(SystemNode, 2, 2, 110);
PlotStateLargeGoal(SystemNode);
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
...
target = SystemNode.State.Manipulator(2).position
target = target + [0 0.4 0];
SystemNode = RepositionManipulator(SystemNode, 2, target);
PlotStateLargeGoal(SystemNode)
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
...
SystemNode = ClampCable(SystemNode, 1, 2);
SystemNode = ClampCable(SystemNode, 2, 1);
PlotStateLargeGoal(SystemNode);
F(LoopCount) = getframe;
CurrLoopCount = LoopCount;
for(LoopCount = [CurrLoopCount+1:CurrLoopCount+29])
...
save MovieFrames.mat F

target1 =  SystemNode.State.Manipulator(1).position + [0 0.3 0];
target2 = SystemNode.State.Manipulator(2).position