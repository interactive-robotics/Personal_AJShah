...
[ OutNode InterlinkResolutionSuccessFlag ] = ResolveInterlinkConflict( GraspNode, TransitionHandle, Tolerance, OccupiedManipulators, FreeManipulators, ClampingManipulator )
SystemNode = OutNode;
