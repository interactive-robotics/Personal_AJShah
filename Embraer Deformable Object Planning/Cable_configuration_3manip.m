...
Manipulator(3).position = [0.5 0.5 0];
Manipulator(3).cable = [];
Manipulator(3).grip = [];
...
[SystemNode GraspNode ParentNode TransitionHandle flag] = AlignRefPoint(SystemNode, 1, 1, 1, 0.05);
PlotStateLargeGoal(SystemNode)

[SystemNode ParentNode RefID ManipID flag] = GraspMultipleRefPoint(GraspNode, [2 3], [2 3], [1 1], 0.05);
PlotStateLarge(SystemNode)

[SystemNode] = TransitionHandle(SystemNode);
PlotStateLarge(SystemNode)
