function [ out ] = PlotStateLargeCorrespondingCableGrip( InNode, CorrespondingCablesStruct )
...
%     hl3 = plot(refPointPos.state(:,1), refPointPos.state(:,2), 'k*', 'MarkerSize', 20, 'LineWidth', 3 );
     ...
     hl4= plot(GripPointPos.state(:,1) , GripPointPos.state(:,2) , 'r*' , 'MarkerSize' , 8, 'LineWidth' , 1);
...
axis equal; 
legend([hl1 hl2 hl4 hl5 hl6 hl7] , 'Cables' , 'Clamp Positions'  , 'Grip Points' , 'Manipulator' , 'Interlink not Stretched' , 'Interlink Stretched')
set(gca, 'XTickLabel' , '')
set(gca, 'YTickLabel' , '')
set(gca , 'FontSize' , 20)
title('Relevant Grip Points')
hold off;
grid on
box on
