...
SystemNode = GraspCable(SystemNode, 1, 1, 20);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 1);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 1, 130);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 2);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 1, 240);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 3);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 1, 350);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 4);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 1, 460);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 5);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 1, 570);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 6);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 20);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 1);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 130);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 2);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 240);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 3);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 350);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 4);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 460);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 5);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 2, 570);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 6);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 20);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 1);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 130);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 2);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 240);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 3);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 350);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 4);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 460);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 5);
PlotState(SystemNode);
pause(0.5)
SystemNode = GraspCable(SystemNode, 1, 3, 570);
PlotState(SystemNode);
pause(0.5)
SystemNode = ClampCable(SystemNode, 1, 6);
PlotState(SystemNode);
