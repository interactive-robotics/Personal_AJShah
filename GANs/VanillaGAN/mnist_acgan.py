...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        progress_bar1 = Progbar(target=num_batches)
        progress_bar2 = Progbar(target=num_batches)
        ...
        progress_bar3 = Progbar(target=3)
        for e in range(3):
            ...
            # generate a new batch of noise
                ...
                epoch_disc_loss.append(discriminator.train_on_batch(
                    x, y))
                progress_bar2.update(index+1)
            progress_bar3.update(e+1)
