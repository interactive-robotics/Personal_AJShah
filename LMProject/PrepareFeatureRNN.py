...
def GetFeatures(scenarios, FeatureClass):
    ...
    #Define the path of the data source
...
def GetTestAndTrainDataOwnship(scenarios, TestScenario, WindowSize=5):
...
#    WindowFeatures, Labels_final = CreateWindowFeatures(NumericFeatures, Labels, StartID, EndID, WindowSize)
    ...
    Scenarios = ['1A','1B','1C']
    TestScenario = ['1B']
    X_train,y_train,X_test,y_test,TrainStartID,TrainEndID,TestStartID,TestEndID = GetTestAndTrainDataOwnshipWingman(Scenarios, TestScenario, WindowSize=1)
