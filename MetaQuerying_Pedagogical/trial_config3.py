...
conditions = ['Pedagogical', 'Noisy Pedagogical 1', 'Noisy Pedagogical 5', 'Non Pedagogical',
              'Info Gain Pedagogical', 'Info Gain Noisy Pedagogical 1', 'Info Gain Noisy Pedagogical 5', 'Info Gain']
...
args.append({'n_query': n_query, 'query_strategy': 'max_model_change', 'meta_policy': 'max_model_change': True, 'selectivity': 1})
args.append({'n_query': n_query, 'query_strategy': 'max_model_change', 'meta_policy': 'max_model_change': True, 'selectivity': 5})
args.append({'n_query': n_query, 'query_strategy': 'max_model_change', 'meta_policy': 'max_model_change': False})
