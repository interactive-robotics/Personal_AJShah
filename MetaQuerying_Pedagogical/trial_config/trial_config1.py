...
conditions = ['Uncertainty Sampling', 'Info Gain', 'Model Change', 'Uncertainty Sampling top-2', 'Info Gain top-2', 'Model Change top-2', 'Uncertainty Sampling top-3', 'Info Gain top-3', 'Model Change top-3']
...
args.append({'n_query': n_query, 'k':3, 'query_strategy': 'uncertainty_sampling',})
args.append({'n_query': n_query, 'k':3, 'query_strategy': 'info_gain',})
args.append({'n_query': n_query, 'k':3, 'query_strategy': 'max_model_change'})
