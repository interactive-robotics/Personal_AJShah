...
args1 = {'n_query': n_query, 'k':3, 'query_strategy': 'uncertainty_sampling',}
args2 = {'n_query': n_query, 'k':3, 'query_strategy': 'info_gain',}
args3 = {'n_query': n_query, 'k':3, 'query_strategy': 'max_model_change'}
...
result_path = f'/home/ajshah/Results/Results_15_Active3'
